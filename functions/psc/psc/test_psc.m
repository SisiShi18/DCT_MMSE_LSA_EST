...
clear all; close all; % clc;
    ...
    [speech.clean, fs] = audioread(file.clean); % read audio samples from the input file
    [speech.noisy, fs] = audioread(file.noisy); % read audio samples from the input file
